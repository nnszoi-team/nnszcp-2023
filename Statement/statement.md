...
小 E 的超能力随时可能消失，为了尽快达成目标，他想得到一个发动超能力的方案，使得在他发动超能力**至多 $1,800$ 次**以后，点 $\left( \frac{a}{b}, \frac{c}{d} \right)$ 上面有一颗星星。
...
第一行一个正整数 $n$，代表小 E 需要发动超能力的次数。**你需要保证 $1 \le n \le 1,800$**。
