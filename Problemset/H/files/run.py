...
def generate(n, t, sc, subtask, count, title, num):
    system(f"./gen --n={n} --t={t} > ./data/{f'{count:03d}'}_{f'{subtask:03d}'}_{title}_{f'{num:03d}'}.in")
...
for i in range(13, 19):
    generate(200000 - i + 13, 210000000, 12, 2, i, "spec_chain", i - 12)

for i in range(19, 26):
    generate(200000 - i + 19, -210000000, 12, 3, i, "spec_star", i - 18)

for i in range(26, 41):
    generate(200000 - i + 26, randint(-100, 100), 42, 4, i, "big_rand", i - 25)

for i in range(41, 46):
    generate(200000 - i + 41, -10000, 42, 4, i, "big_star_like", i - 40)

for i in range(46, 51):
    generate(200000 - i + 46, 10000, 42, 4, i, "big_chain_like", i - 45)
